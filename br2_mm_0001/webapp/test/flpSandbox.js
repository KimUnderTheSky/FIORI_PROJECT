		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[C1_MM] 검수 정보 확인 프로그램",
									"targetURL": "#sync4c1br2mm0001-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4c1br2mm0001-display": {
								"semanticObject": "sync4c1br2mm0001",
								"action": "display",
								"description": "거래처, 자재 별 검수 정보 확인",
								"title": "[C1_MM] 검수 정보 확인 프로그램",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.c1.br2mm0001",
									"url": sap.ui.require.toUrl("sync4/c1/br2mm0001")
								}
							}
						}
					}
