		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[C1_MM] 구매오더 조회 프로그램",
									"targetURL": "#sync4c1br2mm0002-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4c1br2mm0002-display": {
								"semanticObject": "sync4c1br2mm0002",
								"action": "display",
								"description": "구매오더 조회",
								"title": "[C1_MM] 구매오더 조회 프로그램",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.c1.br2mm0002",
									"url": sap.ui.require.toUrl("sync4/c1/br2mm0002")
								}
							}
						}
					}
